...
export const writeProps = (props: Properties, buf: Buffer, offset: number, propsSize: number): Buffer => {
  // 1 byte properties
  ...
  if (propsSize < 129) {
    buf.writeUInt8(propsSize - 1, offset);
    offset++;
  } else if (propsSize < 16_386) {
    const contentSize = propsSize - 2;
    buf.writeUInt16LE(((contentSize & 0b011111110000000) << 1) | (0b10000000 | (contentSize & 0b01111111)), offset);
    offset += 2;
  } else if (propsSize < 2_097_155) {
    const contentSize = propsSize - 3;
    buf.writeUInt16LE(((0b100000000000000 | (contentSize & 0b011111110000000)) << 1) | (0b10000000 | (contentSize & 0b01111111)), offset);
    buf.writeUInt8((contentSize >> 14) & 0b01111111, offset + 2);
    offset += 3;
  } else {
    const contentSize = propsSize - 4;
    buf.writeUInt32LE((((((contentSize >> 21) & 0b01111111) << 8) | (0b10000000 | ((contentSize >> 14) & 0b01111111))) << 16) |
      ((0b100000000000000 | (contentSize & 0b011111110000000)) << 1) | (0b10000000 | (contentSize & 0b01111111)), offset);
    offset += 4;
  }
