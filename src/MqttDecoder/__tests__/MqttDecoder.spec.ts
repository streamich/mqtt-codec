import {connect, connectAck, connectWithClientId, publish3111} from '../../__tests__/util';
...
import {MqttDecoder as v1} from '../v1';
import {MqttDecoder as v2} from '../v2';

const versions = [v1, v2];

for (let i = 0; i < versions.length; i++) {
  const MqttDecoder = versions[i];
  describe(`MqttDecoder v${i + 1}`, () => {
    it('can instantiate', () => {
